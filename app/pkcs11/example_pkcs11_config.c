...
const uint8_t atecc608_config[] = {
    0xC0, 0x00, 0x00, 0x01, 0x8F, 0x20, 0xC4, 0x44, 0x87, 0x20, 0x87, 0x20,
    0x8F, 0x0F, 0xC4, 0x36, 0x9F, 0x0F, 0x82, 0x20, 0x0F, 0x0F, 0xC4, 0x44,
    0x0F, 0x0F, 0x0F, 0x0F, 0x0F, 0x0F, 0x0F, 0x0F, 0x0F, 0x0F, 0x0F, 0x0F,
    0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF,
    0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x33, 0x00, 0x1C, 0x00,
    0x13, 0x00, 0x13, 0x00, 0x7C, 0x00, 0x1C, 0x00, 0x3C, 0x00, 0x33, 0x00,
    0x3C, 0x00, 0x3C, 0x00, 0x3C, 0x00, 0x30, 0x00, 0x3C, 0x00, 0x3C, 0x00,
    0x3C, 0x00, 0x30, 0x00,
};

/* Helper function to assign the proper fields to an certificate object from a
 * cert def */
CK_RV pkcs11_config_cert(pkcs11_lib_ctx_ptr pLibCtx, pkcs11_slot_ctx_ptr pSlot,
  ...
  if (!strncmp(pkcs11configLABEL_DEVICE_CERTIFICATE_FOR_TLS,
               (char *)pLabel->pValue, pLabel->ulValueLen)) {
  ...
  } else if (!strncmp(pkcs11configLABEL_JITP_CERTIFICATE,
                      (char *)pLabel->pValue, pLabel->ulValueLen)) {
